...
echo '======= [4-4] hosts 설정 =========='
cat << EOF >> /etc/hosts
192.168.56.40 dev-tools-server
EOF
...
kubeadm init --pod-network-cidr=20.96.0.0/16 --apiserver-advertise-address 192.168.56.40
...
kubectl taint nodes dev-tools-server node-role.kubernetes.io/control-plane-
